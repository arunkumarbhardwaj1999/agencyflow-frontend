...
export function ClientsSection() {
  return (
    <section id="clients" className="flex items-center bg-slate-100 py-24">
      <div className="mx-auto w-full max-w-6xl px-6 lg:px-10">
        ...
        <div className="mt-14 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
          {clients.map((client) => (
            <div
              key={client.name}
              className="card-hover group flex items-center gap-3 rounded-2xl border border-white bg-white p-4 shadow-sm"
            >
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[1.6fr_1fr]">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-600 via-violet-600 to-indigo-800 p-8 text-white shadow-lg">
            ...
            <div className="relative mt-6 flex flex-wrap items-center gap-3">
              ...
              <div className="ml-0 flex w-full gap-0.5 sm:ml-auto sm:w-auto">
