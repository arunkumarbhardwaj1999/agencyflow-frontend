...
import { Download, FileText, Folders, Trash2, Upload } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500">Files from your assigned projects — upload and download anytime.</p>
      </div>
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <h2 className="mb-4 text-sm font-semibold uppercase tracking-wide text-slate-500">Your files</h2>
        {isLoading ? (
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      {doc.project_id ? (
                        <Link href={`/projects/${doc.project_id}`} className="hover:text-indigo-600 hover:underline">
